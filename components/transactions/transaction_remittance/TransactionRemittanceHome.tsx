...
import { TransactionRemittanceColumnsDataGridList } from "./TransactionRemittanceColumnsDataGridList";
...
const TransactionRemittanceHome = () => {
  ...
  const tempFilterDef: string = "filter=type|stg=OP";
  ...
  return (
    <TableDataGridCustomComponent<IFormFilterTransactionsTableDataGridCustom>
      ...
      page={page}
      rows={rows}
      columns={TransactionRemittanceColumnsDataGridList}
      componentActionFooter={<div></div>}
    />
  );
};

export default TransactionRemittanceHome;
